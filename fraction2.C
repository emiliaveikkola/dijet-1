...
legend->AddEntry(hrk0l, "K^0_L", "f");
legend->AddEntry(hrk0s, "K^0_S", "f");
legend->AddEntry(hrkp, "K^+", "f");
legend->AddEntry(hrk0, "K^0", "f");
legend->AddEntry(hrlambda, "Lambda", "f");
legend->AddEntry(hrsigma0, "Sigma^0", "f");
legend->Draw();
