...
void MCvsDATA_mass() {
    ...
    TH3D* h3MassFlavorPairs_DATAMC_MC = (TH3D*)file->Get("h3MassFlavorPairs_DATAMC");
      ...
      TH3D* h3MassFlavorPairs_DATAMC_SCALEDMASS = (TH3D*)file3->Get("h3MassFlavorPairs_DATAMC");

      // Project Z for different indices and draw
      TH1D* h3all_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3all_mass", 1, 3, 1, 3);

      TH1D* h3gencsall_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3gencsall_mass", 1, 1, 1, 3);
      TH1D* h3genudall_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genudall_mass", 2, 2, 1, 3);
      TH1D* h3genxall_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genxall_mass", 3, 3, 1, 3);

      TH1D* h3tagcsall_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3tagcsall_mass", 1, 3, 1, 1);
      TH1D* h3tagudall_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3tagudall_mass", 1, 3, 2, 2);
      TH1D* h3tagxall_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3tagxall_mass", 1, 3, 3, 3);

      TH1D* h3gencstagcs_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3gencstagcs_mass", 1, 1, 1, 1);
      TH1D* h3gencstagud_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3gencstagud_mass", 1, 1, 2, 2);
      TH1D* h3gencstagx_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3gencstagx_mass", 1, 1, 3, 3);
      
      TH1D* h3genudtagcs_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genudtagcs_mass", 2, 2, 1, 1);
      TH1D* h3genudtagud_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genudtagud_mass", 2, 2, 2, 2);
      TH1D* h3genudtagx_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genudtagx_mass", 2, 2, 3, 3);
      
      TH1D* h3genxtagcs_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genxtagcs_mass", 3, 3, 1, 1);
      TH1D* h3genxtagud_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genxtagud_mass", 3, 3, 2, 2);
      TH1D* h3genxtagx_mass = h3MassFlavorPairs_DATAMC_SCALEDMASS->ProjectionZ("h3genxtagx_mass", 3, 3, 3, 3);
...
/*
    h3gencstagcs_mass->Scale(1./h3all_mass->Integral());
    h3gencstagud_mass->Scale(1./h3all_mass->Integral());
    h3gencstagx_mass->Scale(1./h3all_mass->Integral());
    
    h3genudtagcs_mass->Scale(1./h3all_mass->Integral());
    h3genudtagud_mass->Scale(1./h3all_mass->Integral());
    h3genudtagx_mass->Scale(1./h3all_mass->Integral());

    h3genxtagcs_mass->Scale(1./h3all_mass->Integral());
    h3genxtagud_mass->Scale(1./h3all_mass->Integral());
    h3genxtagx_mass->Scale(1./h3all_mass->Integral());

    h3gencsall_mass->Scale(1./h3all_mass->Integral());
    h3genudall_mass->Scale(1./h3all_mass->Integral());
    h3genxall_mass->Scale(1./h3all_mass->Integral());

    h3tagcsall_mass->Scale(1./h3all_mass->Integral());
    h3tagudall_mass->Scale(1./h3all_mass->Integral());
    h3tagxall_mass->Scale(1./h3all_mass->Integral());

    h3all_mass->Scale(1./h3all_mass->Integral());
*/
...
h3gencstagx_mass->Scale(scale_factor2_mass);
h3genudtagx_mass->Scale(scale_factor2_mass);
h3genxtagx_mass->Scale(scale_factor2_mass);

h3gencstagud_mass->Scale(scale_factor2_mass);
h3genudtagud_mass->Scale(scale_factor2_mass);
h3genxtagud_mass->Scale(scale_factor2_mass);

h3gencstagcs_mass->Scale(scale_factor2_mass);
h3genudtagcs_mass->Scale(scale_factor2_mass);
h3genxtagcs_mass->Scale(scale_factor2_mass);

h3gencsall_mass->Scale(scale_factor2_mass);
h3genudall_mass->Scale(scale_factor2_mass);
h3genxall_mass->Scale(scale_factor2_mass);

h3tagcsall_mass->Scale(scale_factor2_mass);
h3tagudall_mass->Scale(scale_factor2_mass);
h3tagxall_mass->Scale(scale_factor2_mass);

h3all_mass->Scale(scale_factor2_mass);
    ...
    TH1D *h1 = tdrHist("h1","N fraction",0,0.017,"Mass (GeV)",55+1e-1,115);
    TCanvas *c1 = tdrCanvas("c1",h1,8,kSquare);

    TH1D *h2 = tdrHist("h2","Tag/Gen",0,10,"Mass (GeV)",55+1e-1,115);
    ...
    h1->GetYaxis()->SetTitleOffset(1.21);
    h1->GetYaxis()->SetLabelSize(0.05);
    h1->GetYaxis()->SetTitleSize(0.068);

    // Draw the histogram
    tdrDraw(h3gencsall,"HPz",kNone,kAzure+7,kSolid,-1,1001,kAzure+7);
    h3gencsall->SetFillColorAlpha(kAzure+7,0.25);

    tdrDraw(h3tagcsall,"Pz",kFullCircle,kViolet+5);
    h3tagcsall->SetMarkerSize(1);
    ...
    leg->AddEntry(h3gencsall, "GEN CS", "FPLE");
    leg->AddEntry(h3tagcsall, "TAG CS", "PLE");
    ...
    tdrDraw(h3divcs,"Pz",kFullCircle,kPink-9);
    h3divcs->SetMarkerSize(0.8);

    gPad->Update();


    // Save the canvas as a .pdf file
    c->SaveAs("pdf/MCvsDATA_Mass_cs.pdf");





    TH1D *h12 = tdrHist("h12","N fraction",0,0.02,"Mass (GeV)",55+1e-1,115);
    TCanvas *c12 = tdrCanvas("c12",h12,8,kSquare);

    TH1D *h22 = tdrHist("h22","Tag/Gen",0,8,"Mass (GeV)",55+1e-1,115);
    TCanvas *c22 = tdrCanvas("c22",h22,8,kSquare);

    TCanvas *c123 = tdrDiCanvas("c123",h12,h22,8,11);
    ...
    tdrDraw(h3tagudall,"Pz",kFullCircle,kViolet+5);
    h3tagudall->SetMarkerSize(0.7);

    // Create a legend
    TLegend *leg120 = tdrLeg(0.7,0.8-0.05*4,0.9,0.82);
    leg120->AddEntry(h3genudall, "GEN UD", "FPLE");
    leg120->AddEntry(h3tagudall, "TAG UD", "PLE");
    ...
    tdrDraw(h3divud,"Pz",kFullCircle,kPink-9);
    h3divud->SetMarkerSize(0.8);

    gPad->Update();


    // Save the canvas as a .pdf file
    c123->SaveAs("pdf/MCvsDATA_Mass_ud.pdf");


    TH1D *h13 = tdrHist("h13","N fraction",0,0.04,"Mass (GeV)",55+1e-1,115);
    TCanvas *c13 = tdrCanvas("c13",h13,8,kSquare);

    TH1D *h23 = tdrHist("h23","Tag/Gen",0,1.5,"Mass (GeV)",55+1e-1,115);
    TCanvas *c23 = tdrCanvas("c23",h23,8,kSquare);

    TCanvas *c133 = tdrDiCanvas("c133",h13,h23,8,11);

    c133->cd(1);

    h13->GetYaxis()->SetTitleOffset(1.2);
    ...
    tdrDraw(h3tagxall,"Pz",kFullCircle,kViolet+5);
    h3tagxall->SetMarkerSize(1);

    // Create a legend
    TLegend *leg13 = tdrLeg(0.7,0.8-0.05*4,0.9,0.82);
    leg13->AddEntry(h3genxall, "GEN X", "FPLE");
    leg13->AddEntry(h3tagxall, "TAG X", "PLE");
    ...
    tdrDraw(h3divx,"Pz",kFullCircle,kPink-9);
    h3divx->SetMarkerSize(1);

    gPad->Update();


    // Save the canvas as a .pdf file
    c133->SaveAs("pdf/MCvsDATA_Mass_x.pdf");
    ...
    h3gencstagx->GetXaxis()->SetTitle("Mass (GeV)");
    ...
    h3genudtagx->GetXaxis()->SetTitle("Mass (GeV)");
    h3genudtagx->GetYaxis()->SetTitle("N frac");

    // Set the x-axis range
    h3genudtagx->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3genxtagx->GetXaxis()->SetTitle("Mass (GeV)");
    h3genxtagx->GetYaxis()->SetTitle("N frac");

        // Set the x-axis range
    h3genxtagx->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3gencstagud->GetYaxis()->SetTitle("N frac");
        ...
        // Set the x-axis range
    h3gencstagud->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3genudtagud->GetYaxis()->SetTitle("N frac");
        ...
        // Set the x-axis range
    h3genudtagud->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3genxtagud->GetYaxis()->SetTitle("N frac");
        ...
        // Set the x-axis range
    h3genxtagud->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3tagudall->GetXaxis()->SetTitle("Mass (GeV)");
    h3tagudall->GetYaxis()->SetTitle("N frac");

        // Set the x-axis range
    h3tagudall->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    h3tagudall_data->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3gencstagcs->GetYaxis()->SetTitle("N frac");
        ...
        // Set the x-axis range
    h3gencstagcs->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed

    h3gencstagcs->GetYaxis()->SetRangeUser(0, 0.00345); // Adjust the range as needed
    ...
    h3genudtagcs->GetXaxis()->SetTitle("Mass (GeV)");
    ...
    h3genxtagcs->GetXaxis()->SetTitle("Mass (GeV)");
    h3genxtagcs->GetYaxis()->SetTitle("N frac");

        // Set the x-axis range
    h3genxtagcs->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3tagcsall_data->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3gencsall->GetXaxis()->SetTitle("Mass (GeV)");
    h3gencsall->GetYaxis()->SetTitle("N frac");

        // Set the x-axis range
    h3gencsall->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3genudall->GetXaxis()->SetTitle("Mass (GeV)");
    h3genudall->GetYaxis()->SetTitle("N frac");

        // Set the x-axis range
    h3genudall->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3genxall->GetXaxis()->SetTitle("Mass (GeV)");
    h3genxall->GetYaxis()->SetTitle("N frac");

        // Set the x-axis range
    h3genxall->GetXaxis()->SetRangeUser(55, 115); // Adjust the range as needed
    ...
    h3all->GetXaxis()->SetTitle("Mass (GeV)");
    ...
    // Save the canvas as a .pdf file
    c3->SaveAs("pdf/MCvsDATA_Masses.pdf");
...
setTDRStyle();
    ...
    tdrDraw(h3tagcsall_mass,"HPz",kNone,kOrange-2,kSolid,-1,1001,kOrange-2);
    h3tagcsall_mass->SetFillColorAlpha(kOrange-2,0.25);
    ...
    TLegend *leg103 = tdrLeg(0.65,1.17-0.05*4,0.8,0.78);
    leg103->AddEntry(h3tagcsall, "MC", "FPLE");
    leg103->AddEntry(h3tagcsall_scaled, "scaled MC", "FPLE");
    leg103->AddEntry(h3tagcsall_mass, "scaled mass MC", "FPLE");
    ...
    tdrDraw(h_tagcsvsdata_mass,"Pz",kFullCircle,kOrange-2);
    ...
    tex103->DrawLatex(0.17, 0.71, Form("#chi_{mod. mass MC}^{2} / NDF = %1.1f / %d", chi27f, ndf7f));
    ...
    h_tagudvsdata->GetYaxis()->SetRangeUser(0, 2.6); // Adjust the range as needed
    ...
    // Save the canvas as a .pdf file
    c100->SaveAs("pdf/MCvsDATA_Masses_scaled.pdf");
