...
#include "tdrstyle_mod22.C"
   ...
   // Assuming udstag, ctag, btag, and gtag are member variables of StrangeResponse_ud
...
void StrangeResponse_ud::Loop()
{
//   In a ROOT session, you can do:
//      root> .L StrangeResponse_ud.C
//      root> StrangeResponse_ud t
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   TFile *fout = new TFile("output_stag_ud_response.root","recreate");

   // Create a 2D ud_histogram
      // Create a 2D ud_histogram
   TH1D *ud_hJetPairs = new TH1D("ud_hJetPairs", ";Jet pair;N",7,1,8);

   TH1D *ud_hJetPairs_scaled = new TH1D("ud_hJetPairs_scaled", ";Jet pair;N",7,1,8);

   TH1D *ud_h_cs = new TH1D("ud_h_cs", "; All in X;N", 1,0,1);
   TH1D *ud_h_ud = new TH1D("ud_h_ud", "; All in X;N", 1,1,2);
   TH1D *ud_h_cd = new TH1D("ud_h_cd", "; All in X;N", 1,2,3);
   TH1D *ud_h_us = new TH1D("ud_h_us", "; All in X;N", 1,3,4);
   TH1D *ud_h_cb = new TH1D("ud_h_cb", "; All in X;N", 1,4,5);
   TH1D *ud_h_ub = new TH1D("ud_h_ub", "; All in X;N", 1,5,6);
   TH1D *ud_h_x = new TH1D("ud_h_x", "; All in X;N", 1,6,7);

   TH1D *ud_h_x_cs = new TH1D("ud_h_x_cs", "; CS;N", 1,0,1);
   TH1D *ud_h_x_antics = new TH1D("ud_h_x_antics", "; CS;N", 1,0,1);
   TH1D *ud_h_x_anticantis = new TH1D("ud_h_x_anticantis", "; CS;N", 1,0,1);

   TH1D *ud_h_x_sd = new TH1D("ud_h_x_sd", "; SD;N", 1,0,1);
   TH1D *ud_h_x_antisd = new TH1D("ud_h_x_antisd", "; SD;N", 1,0,1);
   TH1D *ud_h_x_antisantid = new TH1D("ud_h_x_antisantid", "; SD;N", 1,0,1);

   TH1D *ud_h_x_cd = new TH1D("ud_h_x_cd", "; CD;N", 1,0,1);
   TH1D *ud_h_x_anticd = new TH1D("ud_h_x_anticd", "; CD;N", 1,0,1);
   TH1D *ud_h_x_anticantid = new TH1D("ud_h_x_anticantid", "; CD;N", 1,0,1);

   TH1D *ud_h_x_su = new TH1D("ud_h_x_su", "; SU;N", 1,0,1);
   TH1D *ud_h_x_antisu = new TH1D("ud_h_x_antisu", "; SU;N", 1,0,1);
   TH1D *ud_h_x_antisantiu = new TH1D("ud_h_x_antisantiu", "; SU;N", 1,0,1);

   TH1D *ud_h_x_cu = new TH1D("ud_h_x_cu", "; CU;N", 1,0,1);
   TH1D *ud_h_x_anticu = new TH1D("ud_h_x_anticu", "; CU;N", 1,0,1);
   TH1D *ud_h_x_anticantiu = new TH1D("ud_h_x_anticantiu", "; CU;N", 1,0,1);

   TH1D *ud_h_x_sb = new TH1D("ud_h_x_sb", "; SB;N", 1,0,1);
   TH1D *ud_h_x_antisb = new TH1D("ud_h_x_antisb", "; SB;N", 1,0,1);
   TH1D *ud_h_x_antisantib = new TH1D("ud_h_x_antisantib", "; SB;N", 1,0,1);

   TH1D *ud_h_x_cb = new TH1D("ud_h_x_cb", "; CB;N", 1,0,1);
   TH1D *ud_h_x_anticb = new TH1D("ud_h_x_anticb", "; CB;N", 1,0,1);
   TH1D *ud_h_x_anticantib = new TH1D("ud_h_x_anticantib", "; CB;N", 1,0,1);

   TH1D *ud_h_x_sg = new TH1D("ud_h_x_sg", "; SG;N", 1,0,1);
   TH1D *ud_h_x_antisg = new TH1D("ud_h_x_antisg", "; SG;N", 1,0,1);

   TH1D *ud_h_x_cg = new TH1D("ud_h_x_cg", "; CG;N", 1,0,1);
   TH1D *ud_h_x_anticg = new TH1D("ud_h_x_anticg", "; CG;N", 1,0,1);

   TH1D *ud_h_x_ud = new TH1D("ud_h_x_ud", "; UD;N", 1,1,2);
   TH1D *ud_h_x_antiud = new TH1D("ud_h_x_antiud", "; UD;N", 1,1,2);
   TH1D *ud_h_x_antiuantid = new TH1D("ud_h_x_antiuantid", "; UD;N", 1,1,2);

   TH1D *ud_h_x_us = new TH1D("ud_h_x_us", "; US;N", 1,1,2);
   TH1D *ud_h_x_antius = new TH1D("ud_h_x_antius", "; US;N", 1,1,2);
   TH1D *ud_h_x_antiuantis = new TH1D("ud_h_x_antiuantis", "; US;N", 1,1,2);

   TH1D *ud_h_x_ds = new TH1D("ud_h_x_ds", "; DS;N", 1,1,2);
   TH1D *ud_h_x_antids = new TH1D("ud_h_x_antids", "; DS;N", 1,1,2);
   TH1D *ud_h_x_antidantis = new TH1D("ud_h_x_antidantis", "; DS;N", 1,1,2);

   TH1D *ud_h_x_uc = new TH1D("ud_h_x_uc", "; UC;N", 1,1,2);
   TH1D *ud_h_x_antiuc = new TH1D("ud_h_x_antiuc", "; UC;N", 1,1,2);
   TH1D *ud_h_x_antiuantic = new TH1D("ud_h_x_antiuantic", "; UC;N", 1,1,2);

   TH1D *ud_h_x_dc = new TH1D("ud_h_x_dc", "; DC;N", 1,1,2);
   TH1D *ud_h_x_antidc = new TH1D("ud_h_x_antidc", "; DC;N", 1,1,2);
   TH1D *ud_h_x_antidantic = new TH1D("ud_h_x_antidantic", "; DC;N", 1,1,2);

   TH1D *ud_h_x_ub = new TH1D("ud_h_x_ub", "; UB;N", 1,1,2);
   TH1D *ud_h_x_antiub = new TH1D("ud_h_x_antiub", "; UB;N", 1,1,2);
   TH1D *ud_h_x_antiuantib = new TH1D("ud_h_x_antiuantib", "; UB;N", 1,1,2);

   TH1D *ud_h_x_db = new TH1D("ud_h_x_db", "; DB;N", 1,1,2);
   TH1D *ud_h_x_antidb = new TH1D("ud_h_x_antidb", "; DB;N", 1,1,2);
   TH1D *ud_h_x_antidantib = new TH1D("ud_h_x_antidantib", "; DB;N", 1,1,2);

   TH1D *ud_h_x_ug = new TH1D("ud_h_x_ug", "; UG;N", 1,1,2);
   TH1D *ud_h_x_antiug = new TH1D("ud_h_x_antiug", "; UG;N", 1,1,2);

   TH1D *ud_h_x_dg = new TH1D("ud_h_x_dg", "; DG;N", 1,1,2);
   TH1D *ud_h_x_antidg = new TH1D("ud_h_x_antidg", "; DG;N", 1,1,2);

   TH1D *ud_h_x_x = new TH1D("ud_h_x_x", "; X;N", 1,6,7);
   TH1D *ud_h_x_gg = new TH1D("ud_h_x_gg", "; X;N", 1,6,7);

   TProfile *h_ud_resp = new TProfile("h_ud_resp", ";p_{T,gen} (GeV);"
			                       "p_{T,reco}/p_{T,gen}",100,0,50);
   

   TLorentzVector p4genjet1, p4genjet2, p4recojet1, p4recojet2, p4recojet_scaled1, p4recojet_scaled2;
      ...
      if (time>0) cout << Form("\n\%1.0f ev/s\n",nlap2/time) << flush;
         ...
         if (fitProb > 0.2){
            ...
            if (binIndex == 7){
               ...
               if (binXIndex == 1) ud_h_x_antics->Fill(0);
               if (binXIndex == 2) ud_h_x_cs->Fill(0);
               if (binXIndex == 3) ud_h_x_anticantis->Fill(0);

               if (binXIndex == 4) {ud_h_x_antisd->Fill(0); ud_h_x_antids->Fill(1);}
               if (binXIndex == 5) {ud_h_x_sd->Fill(0); ud_h_x_ds->Fill(1);}
               if (binXIndex == 6) {ud_h_x_antisantid->Fill(0); ud_h_x_antidantis->Fill(1);}

               if (binXIndex == 7) {ud_h_x_anticd->Fill(0); ud_h_x_antidc->Fill(1);}
               if (binXIndex == 8) {ud_h_x_cd->Fill(0); ud_h_x_dc->Fill(1);}
               if (binXIndex == 9) {ud_h_x_anticantid->Fill(0); ud_h_x_antidantic->Fill(1);}

               if (binXIndex == 10) {ud_h_x_antisu->Fill(0); ud_h_x_antius->Fill(1);}
               if (binXIndex == 11) {ud_h_x_su->Fill(0); ud_h_x_us->Fill(1);}
               if (binXIndex == 12) {ud_h_x_antisantiu->Fill(0); ud_h_x_antiuantis->Fill(1);}

               if (binXIndex == 13) {ud_h_x_anticu->Fill(0); ud_h_x_antiuc->Fill(1);}
               if (binXIndex == 14) {ud_h_x_cu->Fill(0); ud_h_x_uc->Fill(1);}
               if (binXIndex == 15) {ud_h_x_anticantiu->Fill(0); ud_h_x_antiuantic->Fill(1);}

               if (binXIndex == 16) ud_h_x_antisb->Fill(0);
               if (binXIndex == 17) ud_h_x_sb->Fill(0);
               if (binXIndex == 18) ud_h_x_antisantib->Fill(0);

               if (binXIndex == 19) ud_h_x_anticb->Fill(0);
               if (binXIndex == 20) ud_h_x_cb->Fill(0);
               if (binXIndex == 21) ud_h_x_anticantib->Fill(0);

               if (binXIndex == 22) ud_h_x_sg->Fill(0);
               if (binXIndex == 23) ud_h_x_antisg->Fill(0);

               if (binXIndex == 24) ud_h_x_cg->Fill(0);
               if (binXIndex == 25) ud_h_x_anticg->Fill(0);

               if (binXIndex == 26) ud_h_x_antiud->Fill(1);
               if (binXIndex == 27) ud_h_x_ud->Fill(1);
               if (binXIndex == 28) ud_h_x_antiuantid->Fill(1);

               if (binXIndex == 29) ud_h_x_antiub->Fill(1);
               if (binXIndex == 30) ud_h_x_ub->Fill(1);
               if (binXIndex == 31) ud_h_x_antiuantib->Fill(1);

               if (binXIndex == 32) ud_h_x_antidb->Fill(1);
               if (binXIndex == 33) ud_h_x_db->Fill(1);
               if (binXIndex == 34) ud_h_x_antidantib->Fill(1);

               if (binXIndex == 35) ud_h_x_ug->Fill(1);
               if (binXIndex == 36) ud_h_x_antiug->Fill(1);

               if (binXIndex == 37) ud_h_x_dg->Fill(1);
               if (binXIndex == 38) ud_h_x_antidg->Fill(1);

               if (binXIndex == 50) ud_h_x_gg->Fill(6);
               if (binXIndex == 100) ud_h_x_x->Fill(6);
            ...
            //ud response
            if (binIndex == 2) h_ud_resp->Fill(gen_pt, res, weight);
         } //fitProb > 0.2
      } // jentry

      ud_hJetPairs->SetBinContent(1, ud_h_cs->GetEntries());
      ud_hJetPairs->SetBinContent(2, ud_h_ud->GetEntries());
      ud_hJetPairs->SetBinContent(3, ud_h_cd->GetEntries());
      ud_hJetPairs->SetBinContent(4, ud_h_us->GetEntries());
      ud_hJetPairs->SetBinContent(5, ud_h_ub->GetEntries());
      ud_hJetPairs->SetBinContent(6, ud_h_cb->GetEntries());
      ud_hJetPairs->SetBinContent(7, ud_h_x->GetEntries());

      ud_hJetPairs_scaled->SetBinContent(1, ud_h_cs->GetEntries()/0.5722);
      ud_hJetPairs_scaled->SetBinContent(2, ud_h_ud->GetEntries()/0.70812);
      ud_hJetPairs_scaled->SetBinContent(3, ud_h_cd->GetEntries());
      ud_hJetPairs_scaled->SetBinContent(4, ud_h_us->GetEntries());
      ud_hJetPairs_scaled->SetBinContent(5, ud_h_ub->GetEntries());
      ud_hJetPairs_scaled->SetBinContent(6, ud_h_cb->GetEntries());
      ud_hJetPairs_scaled->SetBinContent(7, ud_h_x->GetEntries());
