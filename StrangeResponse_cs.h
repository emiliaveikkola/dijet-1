...
#ifndef StrangeResponse_cs_h
#define StrangeResponse_cs_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   StrangeResponse_cs(TTree *tree=0);
   virtual ~StrangeResponse_cs();
...
#ifdef StrangeResponse_cs_cxx
StrangeResponse_cs::StrangeResponse_cs(TTree *tree) : fChain(0) 
{
...
StrangeResponse_cs::~StrangeResponse_cs()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t StrangeResponse_cs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StrangeResponse_cs::LoadTree(Long64_t entry)
{
...
void StrangeResponse_cs::Init(TTree *tree)
{
...
Bool_t StrangeResponse_cs::Notify()
{
...
void StrangeResponse_cs::Show(Long64_t entry)
{
...
Int_t StrangeResponse_cs::Cut(Long64_t entry)
{
...
#endif // #ifdef StrangeResponse_cs_cxx
