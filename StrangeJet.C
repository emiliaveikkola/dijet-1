...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  TH1D *h_sall = new TH1D("h_sall",";PtCand, all S jets;N", nxbins, xbins);
  TH1D *h_uall = new TH1D("h_uall",";PtCand, all U jets;N", nxbins, xbins);
  TH1D *h_dall = new TH1D("h_dall",";PtCand, all D jets;N", nxbins, xbins);
