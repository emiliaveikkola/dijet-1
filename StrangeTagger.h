...
#ifndef StrangeTagger_h
#define StrangeTagger_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   StrangeTagger(TTree *tree=0);
   virtual ~StrangeTagger();
...
#ifdef StrangeTagger_cxx
StrangeTagger::StrangeTagger(TTree *tree) : fChain(0) 
{
...
StrangeTagger::~StrangeTagger()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t StrangeTagger::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StrangeTagger::LoadTree(Long64_t entry)
{
...
void StrangeTagger::Init(TTree *tree)
{
...
void StrangeTagger::Show(Long64_t entry)
{
...
Int_t StrangeTagger::Cut(Long64_t entry)
{
