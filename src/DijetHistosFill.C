...
public:
  ...
  TProfile2D *p2jes, *p2jsf, *p2effz, *p2eff, *p2pur;
  TProfile2D *p2r, *p2r_s, *p2r_ud, *p2r_g, *p2r_c, *p2r_b;
  TH2D *h2r, *h2r_s, *h2r_ud, *h2r_g, *h2r_c, *h2r_b;
  TProfile *p1r, *p1r_s, *p1r_ud, *p1r_g, *p1r_c, *p1r_b;
  TProfile *h1r, *h1r_s, *h1r_ud, *h1r_g, *h1r_c, *h1r_b;
};
...
//by  b_branchname->GetEntry(ientry); //read only this branch
   ...
   if (dataset=="Summer22EE" ||
     ...
     jec = getFJC("",//Summer22EEPrompt22_V1_MC_L1FastJet_AK4PFPuppi",
		  ...
		  "Winter22Run3_V2_MC_L2Relative_AK4PFPuppi", // Mikel //testi
   ...
   double vptd_e[] = 
     //{59.,85.,104.,170.,236., 302., 370., 460., 575.}; // central
     //{86., 110., 132., 204., 279., 373.} // forward
     {0.0, 2.0202020202020203, 4.040404040404041, 6.0606060606060606, 8.080808080808081, 10.101010101010102, 
     12.121212121212121, 14.141414141414142, 16.161616161616163, 18.181818181818183, 20.202020202020204, 
     22.222222222222225, 24.242424242424242, 26.262626262626263, 28.282828282828284, 30.303030303030305, 
     32.323232323232325, 34.343434343434346, 36.36363636363637, 38.38383838383839, 40.40404040404041, 
     42.42424242424243, 44.44444444444445, 46.46464646464647, 48.484848484848484, 50.505050505050505, 
     52.525252525252526, 54.54545454545455, 56.56565656565657, 58.58585858585859, 60.60606060606061, 
     62.62626262626263, 64.64646464646465, 66.66666666666667, 68.68686868686869, 70.70707070707071, 
     72.72727272727273, 74.74747474747475, 76.76767676767678, 78.7878787878788, 80.80808080808082, 82.82828282828284, 
     84.84848484848486, 86.86868686868688, 88.8888888888889, 90.90909090909092, 92.92929292929294, 94.94949494949496, 
     96.96969696969697, 98.98989898989899, 101.01010101010101, 103.03030303030303, 105.05050505050505, 107.07070707070707, 
     109.0909090909091, 111.11111111111111, 113.13131313131314, 115.15151515151516, 117.17171717171718, 119.1919191919192, 
     121.21212121212122, 123.23232323232324, 125.25252525252526, 127.27272727272728, 129.2929292929293, 131.31313131313132, 
     133.33333333333334, 135.35353535353536, 137.37373737373738, 139.3939393939394, 141.41414141414143, 143.43434343434345, 
     145.45454545454547, 147.4747474747475, 149.4949494949495, 151.51515151515153, 153.53535353535355, 155.55555555555557, 
     157.5757575757576, 159.5959595959596, 161.61616161616163, 163.63636363636365, 165.65656565656568, 167.6767676767677, 
     169.69696969696972, 171.71717171717174, 173.73737373737376, 175.75757575757578, 177.7777777777778, 179.79797979797982, 
     181.81818181818184, 183.83838383838386, 185.85858585858588, 187.8787878787879, 189.89898989898992, 191.91919191919195, 
     193.93939393939394, 195.95959595959596, 197.97979797979798, 200.0};
   double nptd_e = sizeof(vptd)/sizeof(vptd[0])-1;
   ...
   double vxd_e[] =
   {0.5, 0.51010101010101, 0.5202020202020202, 0.5303030303030303, 0.5404040404040404, 0.5505050505050505, 0.5606060606060606, 0.5707070707070707,
    0.5808080808080808, 0.5909090909090909, 0.601010101010101, 0.6111111111111112, 0.6212121212121212, 0.6313131313131313, 0.6414141414141414, 
    0.6515151515151515, 0.6616161616161617, 0.6717171717171717, 0.6818181818181819, 0.6919191919191919, 0.702020202020202, 0.7121212121212122, 
    0.7222222222222222, 0.7323232323232324, 0.7424242424242424, 0.7525252525252526, 0.7626262626262627, 0.7727272727272727, 0.7828282828282829, 
    0.7929292929292929, 0.803030303030303, 0.8131313131313131, 0.8232323232323233, 0.8333333333333334, 0.8434343434343434, 0.8535353535353536, 
    0.8636363636363636, 0.8737373737373737, 0.8838383838383839, 0.893939393939394, 0.9040404040404041, 0.9141414141414141, 0.9242424242424243, 
    0.9343434343434344, 0.9444444444444444, 0.9545454545454546, 0.9646464646464648, 0.9747474747474748, 0.9848484848484849, 0.994949494949495, 
    1.0050505050505052, 1.0151515151515151, 1.0252525252525253, 1.0353535353535355, 1.0454545454545454, 1.0555555555555556, 1.0656565656565657, 
    1.0757575757575757, 1.0858585858585859, 1.095959595959596, 1.106060606060606, 1.1161616161616164, 1.1262626262626263, 1.1363636363636365, 
    1.1464646464646466, 1.1565656565656566, 1.1666666666666667, 1.176767676767677, 1.1868686868686869, 1.196969696969697, 1.2070707070707072, 
    1.2171717171717171, 1.2272727272727273, 1.2373737373737375, 1.2474747474747474, 1.2575757575757578, 1.2676767676767677, 1.2777777777777777, 
    1.287878787878788, 1.297979797979798, 1.3080808080808082, 1.3181818181818183, 1.3282828282828283, 1.3383838383838385, 1.3484848484848486, 
    1.3585858585858586, 1.3686868686868687, 1.378787878787879, 1.3888888888888888, 1.3989898989898992, 1.4090909090909092, 1.4191919191919191, 
    1.4292929292929295, 1.4393939393939394, 1.4494949494949496, 1.4595959595959598, 1.4696969696969697, 1.47979797979798, 1.48989898989899, 1.5};
   const int nxd_e = sizeof(vxd_e)/sizeof(vxd_e[0])-1;
   const int ny = 800;
   double vy[ny+1];
   ...
   for (int itrg = 0; itrg != ntrg; ++itrg) {
     ...
     if (isMC && doMCtruth && vtrg[itrg]=="HLT_MC") {
       ...
       h->p2r = new TProfile2D("p2r",";|#eta_{jet}|;p_{T,gen} (GeV);"
			       "p_{T,jet}/p_{T,gen}",
			       nxd,vxd, nptd, vptd);
       h->h2r = new TH2D("h2r",";p_{T,gen} (GeV);" "p_{T,gen}/p_{T,jet}",
