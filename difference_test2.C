...
void difference_test2() {
    ...
    // Set up the canvas
   TH1D *h = tdrHist("h","S-X N fraction",-0.27 + 1e-4,0.35 -1e-4,"p^{gencand}_{T} (GeV)",20,40);
   TCanvas *c = tdrCanvas("c",h,8,11,kSquare);
    ...
    TH1D *h_hadron_nh_s = (TH1D*)file->Get("h_s_nh_vs_ptcand");
    TH1D *h_hadron_ne_s = (TH1D*)file->Get("h_s_ne_vs_ptcand");
    TH1D *h_hadron_ch_s= (TH1D*)file->Get("h_s_ch_vs_ptcand");
    TH1D *h_s_all= (TH1D*)file->Get("h_all_s_vs_ptcand");

    TH1D *h_hadron_nh_d = (TH1D*)file->Get("h_d_nh_vs_ptcand");
    TH1D *h_hadron_ne_d = (TH1D*)file->Get("h_d_ne_vs_ptcand");
    TH1D *h_hadron_ch_d = (TH1D*)file->Get("h_d_ch_vs_ptcand");
    TH1D *h_d_all= (TH1D*)file->Get("h_all_d_vs_ptcand");

    TH1D *h_hadron_nh_u = (TH1D*)file->Get("h_u_nh_vs_ptcand");
    TH1D *h_hadron_ne_u = (TH1D*)file->Get("h_u_ne_vs_ptcand");
    TH1D *h_hadron_ch_u = (TH1D*)file->Get("h_u_ch_vs_ptcand");
    TH1D *h_u_all= (TH1D*)file->Get("h_all_u_vs_ptcand");

    TH1D *h_hadron_nh_c = (TH1D*)file->Get("h_c_nh_vs_ptcand");
    TH1D *h_hadron_ne_c = (TH1D*)file->Get("h_c_ne_vs_ptcand");
    TH1D *h_hadron_ch_c = (TH1D*)file->Get("h_c_ch_vs_ptcand");
    TH1D *h_c_all= (TH1D*)file->Get("h_all_c_vs_ptcand");

    TH1D *h_hadron_nh_b = (TH1D*)file->Get("h_b_nh_vs_ptcand");
    TH1D *h_hadron_ne_b = (TH1D*)file->Get("h_b_ne_vs_ptcand");
    TH1D *h_hadron_ch_b = (TH1D*)file->Get("h_b_ch_vs_ptcand");
    TH1D *h_b_all= (TH1D*)file->Get("h_all_b_vs_ptcand");

    TH1D *h_hadron_nh_g = (TH1D*)file->Get("h_g_nh_vs_ptcand");
    TH1D *h_hadron_ne_g = (TH1D*)file->Get("h_g_ne_vs_ptcand");
    TH1D *h_hadron_ch_g = (TH1D*)file->Get("h_g_ch_vs_ptcand");
    TH1D *h_g_all= (TH1D*)file->Get("h_all_g_vs_ptcand");
...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    c->Modified();
    c->Update();
    c->SaveAs("energydifference_fraction4.pdf");
