...
#ifndef StrangeResponse_ud_h
#define StrangeResponse_ud_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   StrangeResponse_ud(TTree *tree=0);
   virtual ~StrangeResponse_ud();
...
#ifdef StrangeResponse_ud_cxx
StrangeResponse_ud::StrangeResponse_ud(TTree *tree) : fChain(0) 
{
...
StrangeResponse_ud::~StrangeResponse_ud()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t StrangeResponse_ud::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StrangeResponse_ud::LoadTree(Long64_t entry)
{
...
void StrangeResponse_ud::Init(TTree *tree)
{
...
Bool_t StrangeResponse_ud::Notify()
{
...
void StrangeResponse_ud::Show(Long64_t entry)
{
...
Int_t StrangeResponse_ud::Cut(Long64_t entry)
{
...
#endif // #ifdef StrangeResponse_ud_cxx
