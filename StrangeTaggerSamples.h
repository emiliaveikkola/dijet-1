...
// Thu Apr 11 12:30:43 2024 by ROOT version 6.30/04
// from TTree tree/tree
// found on file: Muo16_MC.root
//////////////////////////////////////////////////////////

#ifndef StrangeTaggerSamples_h
#define StrangeTaggerSamples_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   StrangeTaggerSamples(TTree *tree=0);
   virtual ~StrangeTaggerSamples();
...
#ifdef StrangeTaggerSamples_cxx
StrangeTaggerSamples::StrangeTaggerSamples(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Muo16_MC.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Muo16_MC.root");
      }
...
StrangeTaggerSamples::~StrangeTaggerSamples()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t StrangeTaggerSamples::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t StrangeTaggerSamples::LoadTree(Long64_t entry)
{
...
void StrangeTaggerSamples::Init(TTree *tree)
{
...
Bool_t StrangeTaggerSamples::Notify()
{
...
void StrangeTaggerSamples::Show(Long64_t entry)
{
...
Int_t StrangeTaggerSamples::Cut(Long64_t entry)
{
...
#endif // #ifdef StrangeTaggerSamples_cxx
